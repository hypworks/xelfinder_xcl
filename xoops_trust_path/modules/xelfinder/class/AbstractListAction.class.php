...
/**
 * Xelfinder_AbstractListAction
**/
abstract class Xelfinder_AbstractListAction extends Xelfinder_AbstractAction
{
	public /*** XoopsSimpleObject[] ***/ $mObjects = null;

	public /*** Xelfinder_AbstractFilterForm ***/ $mFilter = null;
	 ...
	 * @param	void
	 * 
	 * @return	Xelfinder_{Tablename}FilterForm
	**/
	...
	**/
	public function getDefaultView()
	{
		...
		return XELFINDER_FRAME_VIEW_INDEX;
	}

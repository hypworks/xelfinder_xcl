...
/**
 * Xelfinder_AbstractAction
**/
abstract class Xelfinder_AbstractAction
{
    public /*** XCube_Root ***/ $mRoot = null;

    public /*** Xelfinder_Module ***/ $mModule = null;

    public /*** Xelfinder_AssetManager ***/ $mAsset = null;
    ...
    **/
     ...
     * @param   void
     * 
     * @return  Xelfinder_{Tablename}Handler
    **/
    ...
    **/
    ...
    {
        return XELFINDER_FRAME_VIEW_NONE;
    }

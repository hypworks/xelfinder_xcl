...
/**
 * Xelfinder_AssetManager
**/
class Xelfinder_AssetManager
{
    public /*** string ***/ $mDirname = '';

    public /*** string ***/ $mTrustDirname = 'xelfinder';
    ...
    **/
     ...
     * @param   string  $dirname
     * 
     * @return  Xelfinder_AssetManager
    **/
    public function &getInstance(/*** string ***/ $dirname)
    {
        /**
         *  @var    Xelfinder_AssetManager[]
        **/
    ...
    **/
    ...
    {
        return XELFINDER_TRUST_PATH . ($isAdmin ? '/admin/' : '/');
    }
}

...
/**
 * Xelfinder_AbstractViewAction
**/
abstract class Xelfinder_AbstractViewAction extends Xelfinder_AbstractAction
{
	...
	**/
	...
	{
		$this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME'), 'list'), 1, _MD_XELFINDER_ERROR_CONTENT_IS_NOT_FOUND);
	}
}

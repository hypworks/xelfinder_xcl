...
/**
 * Xelfinder_AbstractEditAction
**/
abstract class Xelfinder_AbstractEditAction extends Xelfinder_AbstractAction
{
    ...
    **/
    public function getDefaultView()
    {
        ...
        {
            return XELFINDER_FRAME_VIEW_ERROR;
        }
    
        $this->mActionForm->load($this->mObject);
    
        return XELFINDER_FRAME_VIEW_INPUT;
    }
    ...
    **/
    public function execute()
    {
        ...
        {
            return XELFINDER_FRAME_VIEW_CANCEL;
        }
    ...
    **/
    protected function _doExecute()
    {
        ...
        {
            return XELFINDER_FRAME_VIEW_SUCCESS;
        }
    ...
    **/
    ...
    {
        $this->mRoot->mController->executeRedirect($this->_getNextUri($this->_getConst('DATANAME')), 1, _MD_XELFINDER_ERROR_DBUPDATE_FAILED);
    }

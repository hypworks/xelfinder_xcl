...
/**
 * Xelfinder_ContentEditAction
**/
class Xelfinder_ContentEditAction extends Xelfinder_AbstractEditAction
{
    ...
    **/
    ...
    {
        $render->setTemplateName($this->mAsset->mDirname . '_content_edit.html');
